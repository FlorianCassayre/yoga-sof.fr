...
export function NavigationLayout({ children }) {
  ...
  const NavItem = ({ children, className = '' }) => <Nav.Item className={`mb-2 me-2 flex-grow-1 w-100 text-center text-sm-start ${className}`}>{children}</Nav.Item>;
            ...
            <Link href="/administration" passHref>
              <a className="d-flex align-items-center mb-md-0 me-md-auto text-white text-decoration-none mb-2">
                <span className="fs-5 d-none d-sm-inline">
                  Yoga Sof<span className="text-muted fs-6 d-none d-sm-inline"> admin</span>
                </span>
              </a>
            </Link>
