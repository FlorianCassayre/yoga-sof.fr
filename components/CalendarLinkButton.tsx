...
const CalendarDialog: React.FC<CalendarDialogProps> = ({ open, setOpen }) => {
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <DialogContentText>
          Ce lien qui est à copier dans votre application préférée calendrier (<strong>Google Calendar</strong>, <strong>Apple iCloud Calendar</strong>, <strong>Outlook</strong>, ...).
