...
export const schemaCourseCancelQuery = Joi.object({ id: schemaId.required() });
...
export const schemaUserDisabledQuery = Joi.object({ id: schemaId.required() });
