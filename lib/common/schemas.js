...
export const schemaSelfRegistrationCancelQuery = Joi.object({ id: id.required() });
...
export const schemaSessionCancelQuery = Joi.object({ id: id.required() });
...
export const schemaRegistrationCancelQuery = Joi.object({ id: id.required() });
