...
import { emailTemplateSessionCanceledBodyFor, emailTemplateSessionCanceledSubjectFor } from '../common';
  ...
  await Promise.all(registrations
    ...
    .map(({ user }) =>
      dispatchEmail(
        ...
        emailTemplateSessionCanceledSubjectFor(user, session),
        emailTemplateSessionCanceledBodyFor(user, session),
      )
    )
  );
};
