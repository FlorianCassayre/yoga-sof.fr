...
import {
  ...
  EmailAdultCourseRegistrationBody,
  EmailCourseAdultReminderNewcomerBody,
  EmailCourseCanceledBody,
  YOGA_ADULT,
  emailAdultCourseRegistrationSubjectFor,
...
export const notifyCourseRegistration = async (userId, courseIds) => {
  ...
  return dispatchEmailFromComponent(
    user,
    EMAIL_TYPE_REGISTRATION,
    emailAdultCourseRegistrationSubjectFor(registrations),
    <EmailAdultCourseRegistrationBody user={user} registrations={registrations} />,
  );
};
