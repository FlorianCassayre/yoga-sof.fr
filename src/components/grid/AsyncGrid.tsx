...
export const AsyncGrid = <RowModel extends GridValidRowModel, Columns extends GridColumns<RowModel>, TProcedure extends ProcedureQueryArray<RowModel, unknown>>({ columns, procedure, input, getRowId, getRowClassName, initialSort }: AsyncGridProps<RowModel, TProcedure>): JSX.Element => {
